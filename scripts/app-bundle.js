...
define('app',["require", "exports", "./resources/model/route-model", "aurelia-framework", "./resources/model/picture", "./constants", "aurelia-i18n"], function (require, exports, route_model_1, aurelia_framework_1, picture_1, constants_1, aurelia_i18n_1) {
    "use strict";
...
define('components/contact/contact',["require", "exports", "./model/address", "aurelia-i18n", "aurelia-framework"], function (require, exports, address_1, aurelia_i18n_1, aurelia_framework_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('components/language/lang_picker',["require", "exports", "./model/language", "aurelia-framework", "aurelia-i18n"], function (require, exports, language_1, aurelia_framework_1, aurelia_i18n_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('components/language/model/language',["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('components/lang/lang_picker',["require", "exports", "aurelia-framework", "aurelia-i18n", "./model/language"], function (require, exports, aurelia_framework_1, aurelia_i18n_1, language_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var LanguagePicker = (function () {
        function LanguagePicker(i18n) {
            this.dropDownText = i18n.tr(this.getDropDownTextKey());
            this.selectedLang = new language_1.Language("en", "English");
...
define('resources/lang/lang_picker',["require", "exports", "aurelia-framework", "aurelia-i18n", "./resources/model/language"], function (require, exports, aurelia_framework_1, aurelia_i18n_1, language_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var LanguagePicker = (function () {
        function LanguagePicker(i18n) {
...
define('lang_picker',["require", "exports", "aurelia-framework", "aurelia-i18n", "./resources/model/language"], function (require, exports, aurelia_framework_1, aurelia_i18n_1, language_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var LanguagePicker = (function () {
        function LanguagePicker(i18n) {
...
define('langpicker',["require", "exports", "aurelia-framework", "aurelia-i18n", "./resources/model/language"], function (require, exports, aurelia_framework_1, aurelia_i18n_1, language_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var LanguagePicker = (function () {
        function LanguagePicker(i18n) {
...
define('text!components/home/home.html', ['module'], function(module) { module.exports = "<template><require from=\"bootstrap/css/bootstrap.css\"></require><require from=\"semantic-ui/semantic.css\"></require><require from=\"resources/css/styles.css\"></require><div class=\"pad20\"><div class=\"ui centered large header common-font\">Welcome To Daycare Kupalinka</div></div><div class=\"central-text\"><p class=\"central-text\" repeat.for=\"d of data\">${d}</p></div></template>"; });
define('text!components/language/lang_picker.html', ['module'], function(module) { module.exports = "<template></template>"; });
define('text!components/services/services.html', ['module'], function(module) { module.exports = "<template><require from=\"bootstrap/css/bootstrap.css\"></require><require from=\"resources/css/styles.css\"></require><require from=\"semantic-ui/semantic.css\"></require><div class=\"ui three column equal wide grid\"><div class=\"column\"></div><div class=\"six wide column\"><div class=\"ui basic segment common-font\"><div class=\"ui centered large header\">${mainHeader}</div><div class=\"central-text\"><p class=\"central-text justify-right20\" repeat.for=\"t of mainText\">${t}</p></div></div></div><div class=\"column\"></div></div><div class=\"ui horizontal divider common-font\">${dividerText}</div><div class=\"ui basic segment\"></div><div class=\"lr100\"><div class=\"ui five centered cards\"><div class=\"ui grey raised link card\" repeat.for=\"service of services\"><div class=\"image\"><img src=\"${service.pic.path}\"></div><div class=\"content common-font\"><a class=\"header\" disabled=\"true\">${service.name}</a><div class=\"description\">${service.partialData}</div></div><div class=\"extra content common-font\"><button class=\"${service.showFullData() ? 'ui hidden button' : 'ui blue right floated basic button'}\" click.delegate=\"service.onClick()\">Read More</button></div></div></div></div></template>"; });
define('text!components/staff/staff.html', ['module'], function(module) { module.exports = "<template><require from=\"bootstrap/css/bootstrap.css\"></require><require from=\"resources/css/styles.css\"></require><require from=\"semantic-ui/semantic.css\"></require><div class=\"margin10\"><div class=\"ui divided items\"><div class=\"item common-font\" repeat.for=\"employee of employees\"><div class=\"ui medium image\"><img src=\"${employee.pic.path}\"></div><div class=\"content\"><div class=\"header\">${employee.name}</div><div class=\"meta\"><span>${employee.position}</span></div><div class=\"description\"><p class=\"justify-right20\" repeat.for=\"d of employee.data\">${d}</p></div></div></div></div></div></template>"; });
define('text!components/lang/lang_picker.html', ['module'], function(module) { module.exports = "<template><require from=\"resources/css/styles.css\"></require><label for=\"langSelect\" class=\"common-font pad-r10\">${dropDownText}</label><select id=\"langSelect\" value.two-way=\"selectedLang\" style=\"background-color:#696969;border-radius:2px\"><option model.bind=\"l\" selected.bind=\"selectedLang\" repeat.for=\"l of languages\">${l.displayName}</option></select></template>"; });
...
define('text!resources/lang/lang_picker.html', ['module'], function(module) { module.exports = "<template><require from=\"bootstrap/css/bootstrap.css\"></require><require from=\"semantic-ui/semantic.css\"></require><require from=\"resources/css/styles.css\"></require><label for=\"langSelect\" class=\"common-font pad-r10\">${dropDownText}</label><select id=\"langSelect\" style=\"background-color:#696969;border-radius:2px\"><option repeat.for=\"l of languages\">${l.displayName}</option></select></template>"; });
define('text!lang_picker.html', ['module'], function(module) { module.exports = "<template><require from=\"bootstrap/css/bootstrap.css\"></require><require from=\"semantic-ui/semantic.css\"></require><require from=\"resources/css/styles.css\"></require><label for=\"langSelect\" class=\"common-font pad-r10\">${dropDownText}</label><select id=\"langSelect\" style=\"background-color:#696969;border-radius:2px\"><option repeat.for=\"l of languages\">${l.displayName}</option></select></template>"; });
define('text!langpicker.html', ['module'], function(module) { module.exports = "<template>HELLO WORLD</template>"; });
