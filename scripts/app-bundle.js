...
define('components/home/home',["require", "exports", "aurelia-i18n", "aurelia-framework", "aurelia-event-aggregator", "../lang/model/constants", "./model/partner", "../../resources/model/picture"], function (require, exports, aurelia_i18n_1, aurelia_framework_1, aurelia_event_aggregator_1, constants_1, partner_1, picture_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Home = (function () {
    ...
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", String)
    ], Home.prototype, "partnersHeader", void 0);
    __decorate([
        aurelia_framework_1.bindable,
        __metadata("design:type", Array)
    ], Home.prototype, "partners", void 0);
    Home = __decorate([
        aurelia_framework_1.inject(aurelia_i18n_1.I18N, aurelia_event_aggregator_1.EventAggregator),
        __metadata("design:paramtypes", [Object, Object])
    ], Home);
...
define('text!components/home/home.html', ['module'], function(module) { module.exports = "<template><div class=\"links\"><div class=\"ui large header\"><p class=\"common-font\">${partnersHeader}</p></div><div class=\"round-button\" repeat.for=\"p of partners\"><a href=\"${p.refs}\" target=\"_blank\"><img src=\"${p.pic.path}\"></a></div></div><div class=\"central-text common-font\"><div class=\"ui centered large header common-font\">${header}</div><p class=\"central-text common-font\" repeat.for=\"d of data\">${d}</p></div></template>"; });
