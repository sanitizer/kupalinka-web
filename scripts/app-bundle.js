...
define('lang_picker',["require", "exports", "aurelia-framework", "aurelia-i18n", "./model/language"], function (require, exports, aurelia_framework_1, aurelia_i18n_1, language_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    __decorate([
        aurelia_framework_1.bindable({ name: "dropDownText", defaultValue: "" }),
        __metadata("design:type", String)
    ], LanguagePicker.prototype, "dropDownText", void 0);
    __decorate([
        aurelia_framework_1.bindable({ name: "languages", defaultValue: "" }),
        __metadata("design:type", Array)
    ], LanguagePicker.prototype, "languages", void 0);
    __decorate([
        aurelia_framework_1.bindable({ name: "selectedLang", defaultValue: "" }),
...
define('model/language',["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define('components/lang/lang_picker',["require", "exports", "aurelia-framework", "aurelia-i18n", "./model/language"], function (require, exports, aurelia_framework_1, aurelia_i18n_1, language_1) {
    ...
    __decorate([
        aurelia_framework_1.bindable({ defaultValue: "", name: "dropDownText" }),
        __metadata("design:type", String)
    ], LanguagePicker.prototype, "dropDownText", void 0);
    __decorate([
        aurelia_framework_1.bindable({ defaultValue: "", name: "languages" }),
        __metadata("design:type", Array)
    ], LanguagePicker.prototype, "languages", void 0);
    __decorate([
        aurelia_framework_1.bindable({ defaultValue: "", name: "selectedLang" }),
        __metadata("design:type", language_1.Language)
    ], LanguagePicker.prototype, "selectedLang", void 0);
    LanguagePicker = __decorate([
        aurelia_framework_1.inject(aurelia_i18n_1.I18N),
...
define('text!components/lang/lang_picker.html', ['module'], function(module) { module.exports = "<template><require from=\"resources/css/styles.css\"></require><label for=\"langSelect\" class=\"common-font pad-r10\">${dropDownText}</label><select id=\"langSelect\" class=\"select\"><option model.bind=\"l\" selected.bind=\"selectedLang\" repeat.for=\"l of languages\">${l.displayName}</option></select></template>"; });
